...
export const mfaVerifyMutationFn = (
  ...
  options?: SecondParameter<
    typeof customAxiosInstance<MFAVerifySetupSuccessResponse>
  >
) => {
...
export const mfaVerifyForgotPasswordMutationFn = (
  ...
  options?: SecondParameter<
    typeof customAxiosInstance<MFARequestChangePasswordSuccessReponse>
  >
) => {
  return customAxiosInstance<MFARequestChangePasswordSuccessReponse>(
    {
      url: `/mfa/verify/forgot-password`,
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export type MfaSetupQueryFnResult = NonNullable<
  Awaited<ReturnType<typeof mfaSetupQueryFn>>
>;
export type MfaVerifyMutationFnResult = NonNullable<
  Awaited<ReturnType<typeof mfaVerifyMutationFn>>
>;
export type MfaRevokeMutationFnResult = NonNullable<
  Awaited<ReturnType<typeof mfaRevokeMutationFn>>
>;
export type MfaBackupCodeConsumeMutationFnResult = NonNullable<
  Awaited<ReturnType<typeof mfaBackupCodeConsumeMutationFn>>
>;
export type MfaBackupCodeLoginMutationFnResult = NonNullable<
  Awaited<ReturnType<typeof mfaBackupCodeLoginMutationFn>>
>;
export type MfaVerifyLoginMutationFnResult = NonNullable<
  Awaited<ReturnType<typeof mfaVerifyLoginMutationFn>>
>;
export type MfaVerifyForgotPasswordMutationFnResult = NonNullable<
  Awaited<ReturnType<typeof mfaVerifyForgotPasswordMutationFn>>
>;
