const enum ErrorCode {
  ...
  AUTH_ACCESS_TOKEN_USER_NOT_FOUND = "AUTH_ACESS_TOKEN_USER_NOT_FOUND",
  AUTH_ACCESS_TOKEN_SESSION_INVALID = "AUTH_ACCESS_TOKEN_SESSION_INVALID",
  AUTH_ACCESS_TOKEN_SESSION_MISMATCH = "AUTH_ACCESS_TOKEN_SESSION_MISMATCH",
